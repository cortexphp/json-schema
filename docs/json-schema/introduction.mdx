...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="circle-check"
    href="/json-schema/validation/data-validation"
    horizontal
  >
  ...
  <Card
    ...
    href="/json-schema/validation/version-features"
    horizontal
  >
...
<AccordionGroup>
<Accordion title="Primitive Types - Basic data validation">
...
<Accordion title="Complex Types - Structured data validation">
...
<Tip>
Start with Draft-07 for maximum compatibility, then upgrade to Draft 2019-09 or 2020-12 when you need advanced features like `deprecated`, `unevaluatedProperties`, or `dependentSchemas`.
</Tip>
