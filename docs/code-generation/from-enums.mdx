...
$schema = SchemaFactory::fromEnum(UserStatus::class);
...
$prioritySchema = SchemaFactory::fromEnum(Priority::class);
```
...
$paymentSchema = SchemaFactory::fromEnum(PaymentStatus::class);
```
...
$categorySchema = SchemaFactory::fromEnum(ProductCategory::class);
$shippingSchema = SchemaFactory::fromEnum(ShippingMethod::class);
$prioritySchema = SchemaFactory::fromEnum(TicketPriority::class);
```
...
$userAccountSchema = SchemaFactory::object('user_account')
    ->properties(
        ...
        SchemaFactory::fromEnum(UserRole::class)
            ->propertyName('role')
            ->required(),

        SchemaFactory::fromEnum(VerificationStatus::class)
            ->propertyName('verification_status')
            ->default('unverified'),

        SchemaFactory::fromEnum(UserStatus::class)
            ->propertyName('status')
...
$apiResponseSchema = SchemaFactory::object('api_response')
    ->properties(
        SchemaFactory::fromEnum(ApiResponseCode::class)
            ->propertyName('code')
            ->required(),

        SchemaFactory::fromEnum(OperationStatus::class)
            ->propertyName('status')
            ->required(),

        SchemaFactory::string('message'),

        SchemaFactory::object('data')
            ->additionalProperties(true),

        SchemaFactory::array('validation_results')
            ->items(
                SchemaFactory::object()
                    ->properties(
                        SchemaFactory::string('field')->required(),
                        SchemaFactory::fromEnum(ValidationResult::class)
                            ->propertyName('result')
                            ->required(),
                        SchemaFactory::string('message')
                    )
...
$configSchema = SchemaFactory::object('app_config')
    ->properties(
        ...
        SchemaFactory::fromEnum(Environment::class)
            ->propertyName('environment')
            ->required(),

        SchemaFactory::fromEnum(LogLevel::class)
            ->propertyName('log_level')
            ->default('info'),

        SchemaFactory::object('cache')
            ->properties(
                SchemaFactory::fromEnum(CacheDriver::class)
                    ->propertyName('driver')
                    ->default('file'),
                SchemaFactory::integer('ttl')
                    ->minimum(60)
                    ->default(3600)
            ),
        ...
        SchemaFactory::object('database')
            ->properties(
                SchemaFactory::fromEnum(DatabaseDriver::class)
                    ->propertyName('driver')
                    ->required(),
...
$statusSchema = SchemaFactory::fromEnum(UserStatus::class);
...
$taskSchema = SchemaFactory::object('task')
    ->properties(
        SchemaFactory::string('title')->required(),
        SchemaFactory::string('description'),
        SchemaFactory::fromEnum(Priority::class)
...
{
    $schema = SchemaFactory::fromEnum($enumClass);
...
{
    $roleSchema = SchemaFactory::fromEnum(UserRole::class);
