...
$schema = Schema::fromClass(UserRegistration::class);
```
...
$orderSchema = Schema::fromClass(Order::class, SchemaVersion::Draft_2019_09);
...
```php
// Generate schema from class
$userSchema = Schema::fromClass(UserRegistration::class);
